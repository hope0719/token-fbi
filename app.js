...
const TOKENS = [
...

  {
    ...
    how: "打开我的分享链接 https://www.trae.cn/work-fission/PC84E6FCP64U?utm_source=copy_link&utm_medium=friends_invite → 下载并登录 TraeWork 桌面端 → 新账号自动到账 5000 积分，直接选用 GLM-5.3 / GLM-5.2 / DeepSeek V4 Flash / 千问 3.8 Max 模型开始使用",
