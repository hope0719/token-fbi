...
const TOKENS = [
  {
    name: "WorkBuddy",
    type: "工具",
    modality: "HY3（混元3） · HY4 preview（混元4） · 文本模型",
    rating: 5,
    quota: "HY3（混元3）限免至 2026-09-30；HY4 preview 权益调整（9/11-10/10）：新用户首开对话后 14 天每日免费额度，老用户闲时夜间（23:00-次日 8:00）免费、其余时间耗积分",
    signup: "新用户注册送 2000 积分；HY4 preview 新用户（含此前没体验过的老用户）在 10/10 前首次开启，从当天起往后 14 天每日免费额度",
    effect: "腾讯混元 AI 工作台，HY3（混元3）与 HY4 preview（混元4）均可直接调用，速度很快；写代码、查资料、做自动化都好用。HY3 限免期间连续两周全球第一（周调用 11.5 万亿 Token）；HY4 preview 限免临近尾声，9/10 23:59 后调整为「新用户 14 天每日免费 + 老用户夜间免费」；注意 HY4 为纯文本大模型、暂不具备多模态，调用其做视频/图像等生成会切到多模态模型并正常扣积分；免费体验高峰期可能排队",
