...
const TOKENS = [
...

  {
    ...
    how: "打开我的分享链接 https://www.trae.cn/work-fission/ESKME76PNXAY?utm_source=copy_link&utm_medium=friends_invite → 下载并登录 TraeWork 桌面端 → 新账号自动到账 5000 积分，直接选用 GLM-5.3 / GLM-5.2 / DeepSeek V4 Flash / 千问 3.8 Max 模型开始使用",
...

  {
    ...
    how: "报名「2026 微信小程序开发大赛」即可（不用交小程序）→ 约 7-10 天收到 tokenplan 计划卡片 → 抓紧申请、抓紧领",
...

  {
    ...
    how: "打开分享链接 https://chat.b.ai/chat?invite_code=CQLBPC 注册登录 → 在模型列表选 DeepSeek-V4-Flash / Hy3 / MiMo-V2.5 / GLM-5.3-Flash 等免费模型直接使用，或创建 API Key 接入（OpenAI 兼容）",
