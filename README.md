...
站点实时展示 **大模型类 20 家、工具类 8 家**（共 28 张）的最新免费 token 情报，支持按分类筛选（全部 / 大模型 / 工具），限时活动会标注截止日期角标。
...
- **2026-08-18**：恢复「2026 微信小程序开发大赛」卡片（重置于 #8，怎么领补充「报名后约 7-10 天邮件发放 Token」）；总收录回升至 28 张（大模型类 20 · 工具类 8）
