...
站点实时展示 **大模型类 18 家、工具类 8 家**（共 26 张）的最新免费 token 情报，支持按分类筛选（全部 / 大模型 / 工具），限时活动会标注截止日期角标。
...
- **2026-08-12（下午）**：新增「MonkeyCode（长亭）」卡片（工具类，长亭科技出品开源 AI 编程平台，免费档每天 30M Token，签到/邀请可赚积分），评 3 星，置 #26 末尾；总收录升至 26 张（大模型类 18 · 工具类 8）
