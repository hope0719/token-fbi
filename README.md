...
站点实时展示 **大模型类 20 家、工具类 9 家**（共 29 张）的最新免费 token 情报，支持按分类筛选（全部 / 大模型 / 工具），限时活动会标注截止日期角标。
...
| 29 | TeleAgent（星辰超级智能体） | 工具 | 中国电信星辰大模型 · 系统级 AI Agent（对话/编程/调研/文档） | ★★★ |
